$(function() {
    ...
    $('.nav_li').mouseenter(function() {
        $(this).children('.nav_div').stop().slideDown('fast');
    }).mouseleave(function() {
        $(this).children('.nav_div').stop().slideUp('fast');
    });
    ...
    $('#mali ul li label ').click(function(){
        $('#mali ul li').removeClass('checked');
         $(this).parent().addClass('checked');
    });
    $('#chuandong ul li label ').click(function(){
        $('#chuandong ul li').removeClass('checked');
        $(this).parent().addClass('checked');
    });
    $('#gongkuang ul li label ').click(function(){
        $('#gongkuang ul li').removeClass('checked');
        $(this).parent().addClass('checked');
    });
     $('#jiegou ul li label ').click(function(){
        $('#jiegou ul li').removeClass('checked');
        $(this).parent().addClass('checked');
    });



    $('.s_shangpin ul li ').mouseenter(function(){
        $(this).find(".zhezhao").stop(true,false).animate({top:'20px'},1000);
    }).mouseleave(function(){
        $(this).find(".zhezhao").stop(true,false).animate({top:'-20px'},0);
    });

// $('.s_shangpin ul li').mouseenter(function() {
//          $('.zhezhao').animate({top:'20px'},1000);
//     }).mouseleave(function() {
//          $('.zhezhao').animate({top:'-20px'},0);
//     });
});
